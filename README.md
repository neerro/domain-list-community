...
- **dlc.dat**：[https://github.com/neerro/domain-list-community/releases/latest/download/dlc.dat](https://github.com/neerro/domain-list-community/releases/latest/download/dlc.dat)
- **dlc.dat.sha256sum**：[https://github.com/neerro/domain-list-community/releases/latest/download/dlc.dat.sha256sum](https://github.com/neerro/domain-list-community/releases/latest/download/dlc.dat.sha256sum)
